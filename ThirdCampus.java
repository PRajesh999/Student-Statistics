...
public class ThirdCampus extends JFrame {
        ...
        ThirdCampus() {
                ...
                try {
                        ...
                        ResultSet rs1 = st
                                        .executeQuery("select count(*) from Students_Statistics where college='ACOE'");
                        ResultSet rs2 = st1
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='AIML' and college='ACOE'");
                        ResultSet rs3 = st2
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='CSE' and college='ACOE'");
                        ResultSet rs4 = st3
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='DS' and college='ACOE'");
                        ResultSet rs5 = st4
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='IOT' and college='ACOE'");
                        ResultSet rs6 = st5
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='IT' and college='ACOE'");
                        rs1.next();
                        rs2.next();
                        rs3.next();
                        rs4.next();
