...
public class SecondCampus extends JFrame {
        ...
        SecondCampus() {
                ...
                try {
                        ...
                        ResultSet rs1 = st
                                        .executeQuery("select count(*) from Students_Statistics where college='ACET'");
                        ResultSet rs2 = st1
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='AIML' and college='ACET'");
                        ResultSet rs3 = st2
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='CSE' and college='ACET'");
                        ResultSet rs4 = st3
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='DS' and college='ACET'");
                        ResultSet rs5 = st4
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='IOT' and college='ACET'");
                        ResultSet rs6 = st5
                                        .executeQuery("select count(*) from Students_Statistics where BRANCH='IT' and college='ACET'");
                        rs1.next();
                        rs2.next();
                        rs3.next();
                        rs4.next();
